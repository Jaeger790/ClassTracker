...
public class TermActivity extends AppCompatActivity {
    ...
    private final SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyy", Locale.US);
    ...
    public void buildRecyclerView() {
        ...
        public void createTermList () {
            ...
            for (int i = 0; i < listSize; i++) {
                termItemList.add(new TermItem(allTermList.get(i).getTermTitle(), startLabel, endLabel, DateFormat.getDateInstance().format(allTermList.get(i).getStartDate()), DateFormat.getDateInstance().format(allTermList.get(i).getEndDate())));
